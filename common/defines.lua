...
country = {
	...
	BASE_TECH_DECAY 				= -0.005,  -- how many percent lost each month in tech categories.
	MAX_TECH_ABILITY				= 99,
	TECH_ABILITY_GAIN_DIVISOR		= 10,
	NUKE_UNITY_IMPACT	= 0.5,		-- impact from being nukes.
	MOBILIZE_THREAT_IMPACT = 2.5,	-- threat from when mobilizing.
	SPY_THREAT_INCREASE_ACTION = 0.20,	-- daily threat increase from spy action
	...
	NUMBER_OF_VICTORY_CONDITIONS = 12, -- The number of victory conditions each faction needs to pick.
	VICTORY_CONDITIONS_TO_WIN = 15, -- The number of victory conditions each faction needs to win.
	...
	TECH_ESPIONAGE_TECH_PICK_FACTOR = 0.4,
...
economy = {
	...
	IC_TO_SUPPLIES 			= 10.0,
	CONVOY_BUILD_COST 		= 1,
	CONVOY_BUILD_TIME 		= 80,
	ESCORT_BUILD_COST 		= 2,
	ESCORT_BUILD_TIME 		= 150,
	LEADERSHIP_TO_SPIES 		= 0.30,
...
military = {
	...
	SUPPLYPOOL_DAYS = 45,	-- days of supply.
	SUPPLY_SAME_AREA_DIST_CUTOFF = 15, -- No convoys to within this many provinces from the main supplier province
	...
	MINIMUM_STRENGTH = 17,		-- was 50 --minimum strength of a land division at production.  50 = 5000 men.
	...
	PARATROOP_MISSION_ORG_REQ = 0.50, -- Paratroop brigades need at least this percent of max org to perform drops
	UNIT_DIGIN_CAP = 10,
	...
	BASE_NIGHT_PENALTY = -0.4,
	BASE_FORT_PENALTY = -0.05,
	BASE_STACKING_PENALTY = -0.02, -- was -0.1
	...
	LAND_COMBAT_STR_DAMAGE_MODIFIER = 3.0,
	...
	AIR_STACKING_PENALTY = -0.02, --was 0.10
	...
	RADIO_ARMY_LEADER_DISTANCE = 800,
	RADIO_ARMYGROUP_LEADER_DISTANCE = 1500,
	RADIO_THEATHRE_LEADER_DISTANCE = 3000,
...
diplomacy = {
	...
	NAP_EXPIRY_MONTHS = 120,				-- NAPs expire after this many months
...
alignment = {
	...
	WAR_THREAT = 40.0,
	LARGE_COUNTRY_IC = 500.0, -- used to scale threat impact with country IC
